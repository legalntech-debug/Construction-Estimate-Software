...
interface CadToolbarProps {
  ...
  rotateSelectedCadObjects: (degrees: number) => void;
  ...
  return (
    <div className="border-b border-black bg-gray-100 p-2 flex gap-1 flex-wrap items-center">
      {TOOLS.map((tool) => (
        <button
          ...
          className={`px-2 py-1 border border-black text-[9px] font-black cursor-pointer ${
            cadTool === tool ? "bg-blue-700 text-white" : "bg-white"
          }`}
        >
          {tool}
        </button>
      ...
      <button
        ...
        className={`px-2 py-1 border border-black text-[9px] font-black cursor-pointer ${
          orthMode ? "bg-green-600 text-white" : "bg-white"
        }`}
      >
        ORTHO
      </button>
      ...
      <button
        ...
        className={`px-2 py-1 border border-black text-[9px] font-black cursor-pointer ${
          osnapMode ? "bg-green-600 text-white" : "bg-white"
        }`}
      >
        OSNAP
      </button>
      ...
      <button
        ...
        className="px-2 py-1 border border-black text-[9px] font-black bg-yellow-200 cursor-pointer"
      >
        UNDO
      </button>
      ...
      <button
        ...
        className="px-2 py-1 border border-black text-[9px] font-black bg-white cursor-pointer"
      >
        COPY
      </button>
      ...
      <button
        ...
        className="px-2 py-1 border border-black text-[9px] font-black bg-red-100 cursor-pointer"
      >
        DELETE
      </button>
      ...
      <input
        ...
        className="w-16 border border-black p-1 text-[9px] text-center"
        title="Rotation"
      />
      ...
      <input
        ...
        placeholder="TEXT"
        className="w-32 border border-black p-1 text-[9px]"
      />
    </div>
  );
}