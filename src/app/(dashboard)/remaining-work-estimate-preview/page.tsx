...
export default function RemainingWorkEstimatePreviewPage() {
  ...
  // 1. Sabse pehle selectedItems ko declare karein taaki coreItems mein use ho sake
  ...
  // 2. Ab coreItems define karein (jismein selectedItems aur column ki condition safe hai)
  const coreItems = [
    { 
      id: "preliminary",
    ...
    { 
      ...
      ht: (selectedItems.includes("rcc_foundation") || selectedItems.includes("earthwork")) 
      ...
      qty: (
        ...
        ((selectedItems.includes("rcc_foundation") || selectedItems.includes("earthwork")) 
          ? (Number(selectedPlotMaster?.column_height || 0) + Number(selectedPlotMaster?.footing_depth_meter || 0)) 
          : Number(selectedPlotMaster?.column_height || 0)) * 
        totalColumnNos
      ).toFixed(2), 
...
// 3. Financial calculations
  ...
  // 4. Slab and Lift configurations
  ...
  // 5. All rows combined with types and IDs
  const allEstimateRows = [
    ...coreItemsWithAmount,
    { id: "door_frame_desc", description: masterItem.door_frame_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.door || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("door_frame_desc") },
    { id: "paint_putty_desc", description: masterItem.paint_putty_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.paint || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("paint_putty_desc") },
    { id: "ms_steel_desc", description: masterItem.ms_steel_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.ms || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("ms_steel_desc") },
    { id: "plumbing_desc", description: masterItem.plumbing_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.plumb || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("plumbing_desc") },
    { id: "electrical_desc", description: masterItem.electrical_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.elec || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("electrical_desc") },
    { id: "flooring_desc", description: masterItem.flooring_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.floor || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("flooring_desc") },
    { id: "false_ceiling_desc", description: masterItem.false_ceiling_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.ceiling || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("false_ceiling_desc") },
    { id: "modular_kitchen_desc", description: masterItem.modular_kitchen_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.kitchen || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("modular_kitchen_desc") },
    { id: "water_tank_desc", description: masterItem.water_tank_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.water || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("water_tank_desc") },
    { id: "full_home_furnishing_desc", description: masterItem.full_home_furnishing_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.furnish || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("full_home_furnishing_desc") },
    { id: "modern_elevation_desc", description: masterItem.modern_elevation_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.elev || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("modern_elevation_desc") },
    { id: "deep_boring_desc", description: masterItem.deep_boring_desc, l: "-", w: "-", ht: "-", nos: "-", qty: selectedItems.includes("deep_boring_desc") ? 1 : 0, unit: "LS", rate: ((finalW.bore || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("deep_boring_desc") },
    { id: "final_finishing_desc", description: masterItem.final_finishing_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.final || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("final_finishing_desc") },
    { 
      id: "lift_installation_desc", 
      description: masterItem.lift_installation_desc, 
      l: "-", w: "-", ht: "-", nos: "-", qty: (selectedItems.includes("lift_installation_desc") && !isLiftHidden) ? 1 : 0, unit: "LS", 
      rate: ((finalW.lift || 0) * 100).toFixed(1) + "%",
      hidden: isLiftHidden || !selectedItems.includes("lift_installation_desc")
    },
    { id: "consultant_fee_desc", description: masterItem.consultant_fee_desc, l: "-", w: "-", ht: "-", nos: "-", qty: "-", unit: "LS", rate: ((finalW.cons || 0) * 100).toFixed(1) + "%", hidden: !selectedItems.includes("consultant_fee_desc") },
  ];

  // 6. Final Filtered rows
  const estimateRows = allEstimateRows.filter(row => {
    const shouldKeep = selectedItems.includes(row.id) && !row.hidden;
    return shouldKeep;
  });
  ...
  return amount > 0; // Sirf wohi items dikhenge jinki amount 0 se zyada hogi
})
              .map((row, index) => {
                const rateVal = parseFloat((row.rate || "0").toString().replace('%', '')) || 0;
